...
void arp_protocol_packet_handle(
    ...
    {
    case 1:
        strcat(m.analyse_infor, "    ARP请求协议\n");
        break;
    case 2:
        strcat(m.analyse_infor, "    ARP应答协议\n");
        break;
    case 3:
        strcat(m.analyse_infor, "    RARP请求协议\n");
        break;
    case 4:
        strcat(m.analyse_infor, "    RARP应答协议\n");
        break;
    default:
        break;
    }
...
void icmp_protocol_packet_handle(
    ...
    strcat(m.analyse_infor, "剩余内容正在施工中");
...
void ipv6_protocol_packet_handle(
    ...
    strcat(m.analyse_infor, "其余内容正在施工状态\n");
}
    ...
    struct message& m)
{
    ...
    case 6:
        ...
        tcp_protocol_packet_handle(argument, packet_header, packet_content, header_length, tlen, m);
        break;
    case 17:
        strcat(m.analyse_infor, "udp(17)");
        udp_protocol_packet_handle(argument, packet_header, packet_content, header_length, m);
        break;
    case 1:
        strcat(m.analyse_infor, "icmp(1)");
        icmp_protocol_packet_handle(argument, packet_header, packet_content, m);
        break;
    case 41:
        strcat(m.analyse_infor, "ENCAP(41) ipv6封装, 其他内容正在施工中。。。。。");
        strcat(m.protocalType, "unkonwn");
    default:
        strcat(m.analyse_infor, "具体分析内容正在施工中。。。。。");
        strcat(m.protocalType, "unkonwn");
        break;
    }
...
//    printf("MAC Target Address is : \n");
    ...
    switch (ethernet_type) {
    case 0x0800:
        ip_protocol_packet_handle(argument, packet_header, packet_content, m);
        break;
    case 0x0806:
        arp_protocol_packet_handle(argument, packet_header, packet_content, m);
    case 0x86dd:
        ipv6_protocol_packet_handle(argument, packet_header, packet_content, m);
    default:
        m.couldBeJudged = false;
        strcat(m.source, source_mac);
        strcat(m.destiny, destiny_mac);
        strcat(m.protocalType, "unknown");
        strcat(m.analyse_infor, "其他具体内容正在施工中。。。。。");
        break;
    }
}